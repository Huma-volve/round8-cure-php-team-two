...
use App\Http\Controllers\Dashboard\Admin\AdminSummary;
use Illuminate\Support\Facades\Route;

Route::middleware(['auth:admin'])->prefix('admin/dashboard')->name('admin.')->group(function () {
    Route::get('/', [AdminSummary::class, 'index'])->name('dashboard');
    ...
    Route::get('/reports', [AdminDashboardController::class, 'index'])->name('dashboard.reports');
